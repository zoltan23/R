...
for (i in year) {
  url<- paste("https://en.wikipedia.org/wiki/",i,"_NCAA_Division_I_FBS_football_rankings")
  ...
  tbls_ls <- webpage %>%
   ...
   coaches25<-coaches25[
     with(coaches25, order(coaches25.X17)),
   ]
   ...
   #write.table(rankings_data, paste("E:/USB/Web Scraped Datasets/Rankings/Rankings by Team by Year/rankings",i, ".txt",sep=""), sep=" ")
  }  
